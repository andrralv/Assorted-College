...
public class MuestraComercioData extends ManageDocument {
    ...
    public Comercio showData(Document document, int codigo) {
        ...
        int len = nodelist.getLength();
            ...
            Date fechaCreacionComercioDate = proyecto.model.Utilidades.getFecha(fechaCreacionComercio);
            String fechaLicenciaComercio = nodes.item(4).getTextContent();
            Date fechaLicenciaComercioDate = proyecto.model.Utilidades.getFecha(fechaLicenciaComercio);
