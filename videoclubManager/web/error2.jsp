...
<html>
    <head>
        <title>VideoClub Ficticio | Nuevo Usuario</title>
        <meta charset="UTF-8">
        ...
        <link rel="stylesheet" type="text/css" href="CSS/styleGen.css">
	...
	<nav>
        ...
        <section>
            <h3>Ooops. Hemos encontrado un error. <br />Ese filme no esta en el catalogo.<br /></h3> <br />
            <h4>Por favor registrese: <a href="acceso.jsp"><br/>[Volver a Login]</a></h4>
        </section>
    </div>
    <footer>
